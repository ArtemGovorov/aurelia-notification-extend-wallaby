define('app',["exports", "aurelia-framework", "./services/auth-service", "./services/request-status-service"], function (exports, _aureliaFramework, _authService, _requestStatusService) {
    "use strict";
    ...
    var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_authService2.default, _requestStatusService.RequestStatusService), _dec(_class = function () {
        function App(requestStatusService, authService) {
        ...
        App.prototype.configureRouter = function configureRouter(config, router) {
            ...
            config.map([{ route: ["", "home"], name: "home", moduleId: "home", nav: true, title: "Home" }, { route: "login", name: "login", moduleId: "login", nav: false, title: "Login" }, { route: "campaigns", name: "campaigns", moduleId: "campaigns-overview", nav: true, title: "Campagnes" }, { route: "suppliers", name: "suppliers", moduleId: "suppliers-overview", nav: true, title: "Suppliers" }, { route: "trackingdata", name: "tracking", moduleId: "tracking-pixel-information", nav: true, title: "Tracking pixel" }, { route: "leads", name: "leads", moduleId: "leads-overview", nav: true, title: "Leads" }, { route: "batches", name: "leads", moduleId: "batch-overview", nav: true, title: "Batches" }, { route: "upload-batch", moduleId: "batch-upload", nav: true, title: "Batches uploaden" }]);
...
define('batch-upload',["exports", "aurelia-framework", "./services/batch-service", "./services/campaign-service", "./services/supplier-service", "./services/request-status-service", "./models/campaign", "./models/supplier", "aurelia-notification"], function (exports, _aureliaFramework, _batchService, _campaignService, _supplierService, _requestStatusService, _campaign, _supplier, _aureliaNotification) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.BatchUpload = undefined;
    ...
    var BatchUpload = exports.BatchUpload = (_dec = (0, _aureliaFramework.inject)(_batchService.BatchService, _campaignService.CampaignService, _supplierService.SupplierService, _requestStatusService.RequestStatusService, _aureliaNotification.Notification), _dec(_class = function () {
        function BatchUpload(batchService, campaignService, supplierService, requestStatus, notification) {
        ...
        BatchUpload.prototype.activate = function activate() {
            var _this = this;

            return Promise.all([this.campaignService.getAllItems().then(function (response) {
                return _this.campaigns = Array.from(response, function (x) {
                    return new _campaign2.default(x);
                });
            }), this.supplierService.getAllItems().then(function (response) {
                return _this.suppliers = Array.from(response, function (x) {
                    return new _supplier2.default(x);
                });
            })]);
        };

        BatchUpload.prototype.upload = function upload() {
            var _this2 = this;

            return this.batchService.uploadBatch(this.selectedCampaignId, this.selectedSupplierId, this.selectedFiles[0]).then(function (batchId) {
                return _this2.notification.success("Batch #" + batchId + " imported");
            }).then(function () {
                return _this2.clearFiles();
            });
        };

        BatchUpload.prototype.clearFiles = function clearFiles() {
            document.getElementById("files").value = "";
        };

        BatchUpload.prototype._isEmpty = function _isEmpty(value) {
...
define('campaigns-overview',["exports", "aurelia-framework", "aurelia-router", "./services/campaign-service", "./models/campaign", "./components/paged-view"], function (exports, _aureliaFramework, _aureliaRouter, _campaignService, _campaign, _pagedView) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.CampaignsOverview = undefined;
    ...
    var CampaignsOverview = exports.CampaignsOverview = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _campaignService.CampaignService), _dec(_class = function (_PagedView) {
        _inherits(CampaignsOverview, _PagedView);

        function CampaignsOverview(router, campaignService) {
            _classCallCheck(this, CampaignsOverview);

            var _this = _possibleConstructorReturn(this, _PagedView.call(this, router, "campaigns"));

            _this.heading = "Overzicht campagnes";
            _this.campaigns = [];
            _this.numberOfPages = 0;

            _this.campaignService = campaignService;
            return _this;
        }

        CampaignsOverview.prototype.activate = function activate(params) {
            return _PagedView.prototype.getPage.call(this, params.page || params.pagina || 1);
        };

        CampaignsOverview.prototype.getData = function getData(page) {
            var _this2 = this;

            return this.campaignService.getPagedItems(page).then(function (response) {
                _this2.campaigns = Array.from(response.results, function (x) {
                    return new _campaign2.default(x);
                });
                _this2.numberOfPages = response.totalPages;
            });
        };

        return CampaignsOverview;
    }(_pagedView2.default)) || _class);
});
...
define('home',["exports"], function (exports) {
  ...
  var Home = exports.Home = function () {
    ...
    Home.prototype.canDeactivate = function canDeactivate() {};

    return Home;
  }();
});
define('leads-overview',["exports", "aurelia-framework", "aurelia-router", "./services/lead-service", "./models/lead", "./components/paged-view"], function (exports, _aureliaFramework, _aureliaRouter, _leadService, _lead, _pagedView) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.LeadsOverview = undefined;
    ...
    var LeadsOverview = exports.LeadsOverview = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _leadService.LeadService), _dec(_class = function (_PagedView) {
        _inherits(LeadsOverview, _PagedView);

        function LeadsOverview(router, leadService) {
            _classCallCheck(this, LeadsOverview);

            var _this = _possibleConstructorReturn(this, _PagedView.call(this, router, "leads"));

            _this.heading = "Overzicht inkomende leads";
            _this.leads = [];
            _this.numberOfPages = 0;
        ...
        LeadsOverview.prototype.activate = function activate(params) {
            return _PagedView.prototype.getPage.call(this, params.page || params.pagina || 1);
        };

        LeadsOverview.prototype.getData = function getData(page) {
            var _this2 = this;

            return this.leadService.getPagedItems(page).then(function (response) {
                _this2.leads = Array.from(response.results, function (x) {
                    return new _lead2.default(x);
                });
                _this2.numberOfPages = response.totalPages;
            });
        };
...
define('login',["exports", "aurelia-framework", "./services/auth-service"], function (exports, _aureliaFramework, _authService) {
    "use strict";
    ...
    var Login = exports.Login = (_dec = (0, _aureliaFramework.inject)(_authService2.default), _dec(_class = function () {
        ...
        Login.prototype.login = function login() {
            ...
            if (this.username && this.password) {
                ...
                this.auth.logIn({ username: this.username, password: this.password }, this.rememberMe).catch(function (response) {
                    _this.error = true;
                    _this.busy = false;
                });
            }
        ...
        Login.prototype.clearFields = function clearFields() {
            this.username = "";
            this.password = "";
            this.rememberMe = false;
            this.error = false;
...
define('main',["exports", "./environment", "./services/auth-service", "bootstrap"], function (exports, _environment, _authService) {
  "use strict";
  ...
  function configure(aurelia) {
    aurelia.use.standardConfiguration().plugin("aurelia-animator-css").plugin("aurelia-notification", function (config) {
      config.configure({
        translate: false,
        notifications: {
    ...
    aurelia.start().then(function () {
      var root = "app";
      var authService = aurelia.container.get(_authService2.default);
...
define('projects-overview',["exports", "aurelia-framework", "aurelia-router", "./services/project-service", "./models/project", "./components/paged-view"], function (exports, _aureliaFramework, _aureliaRouter, _projectService, _project, _pagedView) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ProjectsOverview = undefined;
    ...
    var ProjectsOverview = exports.ProjectsOverview = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _projectService.ProjectService), _dec(_class = function (_PagedView) {
        _inherits(ProjectsOverview, _PagedView);

        function ProjectsOverview(router, projectService) {
            _classCallCheck(this, ProjectsOverview);

            var _this = _possibleConstructorReturn(this, _PagedView.call(this, router, "projects"));

            _this.heading = "Overzicht projecten";
            _this.projects = [];
            _this.numberOfPages = 0;
        ...
        ProjectsOverview.prototype.activate = function activate(params) {
            return _PagedView.prototype.getPage.call(this, params.page || params.pagina || 1);
        };

        ProjectsOverview.prototype.getData = function getData(page) {
            var _this2 = this;

            return this.projectService.getPagedItems(page).then(function (response) {
                _this2.projects = Array.from(response.results, function (x) {
                    return new _project2.default(x);
                });
                _this2.numberOfPages = response.totalPages;
            });
        };
...
define('suppliers-overview',["exports", "aurelia-framework", "aurelia-router", "./services/supplier-service", "./models/supplier", "./components/paged-view"], function (exports, _aureliaFramework, _aureliaRouter, _supplierService, _supplier, _pagedView) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.SuppliersOverview = undefined;
    ...
    var SuppliersOverview = exports.SuppliersOverview = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _supplierService.SupplierService), _dec(_class = function (_PagedView) {
        _inherits(SuppliersOverview, _PagedView);

        function SuppliersOverview(router, supplierService) {
            _classCallCheck(this, SuppliersOverview);

            var _this = _possibleConstructorReturn(this, _PagedView.call(this, router, "supplier"));

            _this.heading = "Overzicht suppliers";
            _this.suppliers = [];
            _this.numberOfPages = 0;
        ...
        SuppliersOverview.prototype.activate = function activate(params) {
            return _PagedView.prototype.getPage.call(this, params.page || params.pagina || 1);
        };

        SuppliersOverview.prototype.getData = function getData(page) {
            var _this2 = this;

            return this.supplierService.getPagedItems(page).then(function (response) {
                _this2.suppliers = Array.from(response.results, function (x) {
                    return new _supplier2.default(x);
                });
                _this2.numberOfPages = response.totalPages;
            });
...
define('tracking-pixel-information',["exports", "aurelia-framework", "./services/tracking-pixel-service", "./models/tracking-pixel-data"], function (exports, _aureliaFramework, _trackingPixelService, _trackingPixelData) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.TrackingPixelInformation = undefined;

    var _trackingPixelData2 = _interopRequireDefault(_trackingPixelData);
    ...
    var TrackingPixelInformation = exports.TrackingPixelInformation = (_dec = (0, _aureliaFramework.inject)(_trackingPixelService.TrackingPixelService), _dec(_class = function () {
        function TrackingPixelInformation(trackingPixelService) {
            _classCallCheck(this, TrackingPixelInformation);

            this.heading = "Tracking pixel data overzicht";
            this.trackingPixelData = [];

            this.trackingPixelService = trackingPixelService;
        }

        TrackingPixelInformation.prototype.activate = function activate() {
            var _this = this;

            return this.trackingPixelService.getPagedItems(0).then(function (response) {
                return _this.trackingPixelData = Array.from(response, function (x) {
                    return new _trackingPixelData2.default(x);
                });
            });
        };

        TrackingPixelInformation.prototype.canDeactivate = function canDeactivate() {};

        return TrackingPixelInformation;
    }()) || _class);
});
define('components/paged-view',["exports"], function (exports) {
    "use strict";
    ...
    var PagedView = function () {
        function PagedView(router, baseUrl) {
        ...
        PagedView.prototype.getPage = function getPage(page, filter) {
            var _this = this;

            return this.getData(page, filter).then(function () {
                _this.currentPage = page;
                _this._setPushState(page);
            });
        };

        PagedView.prototype.applyFilters = function applyFilters(page) {
            return this.getData(page, this.filter);
        };

        PagedView.prototype.edit = function edit(item) {
            this._navigate(item, "edit");
        };

        PagedView.prototype.add = function add() {
            this._navigate(null, "add");
        };

        PagedView.prototype.details = function details(item) {
            this._navigate(item, "details");
        };

        PagedView.prototype._navigate = function _navigate(selectedItem, module) {
            var id = selectedItem != null ? selectedItem.id + "/" : "";
            var url = this.baseUrl + "/" + id + module;
            this.router.navigate(url);
        };

        PagedView.prototype._setPushState = function _setPushState(page) {};
...
define('models/campaign',["exports", "./customer", "./supplier"], function (exports, _customer, _supplier) {
    "use strict";
    ...
    var Campaign = function Campaign() {
        ...
        this.customer = data.customer ? new _customer2.default(data.customer) : new _customer2.default();
        this.supplier = data.supplier ? new _supplier2.default(data.supplier) : new _supplier2.default();
    };

    exports.default = Campaign;
});
define('models/customer',["exports"], function (exports) {
    "use strict";
...
define('models/lead',["exports"], function (exports) {
    "use strict";
...
define('models/project',["exports"], function (exports) {
    "use strict";
...
define('models/supplier',["exports"], function (exports) {
    "use strict";
...
define('models/tracking-pixel-data',["exports", "./campaign", "./supplier"], function (exports, _campaign, _supplier) {
    "use strict";
    ...
    var TrackingPixelData = function TrackingPixelData() {
        var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

        _classCallCheck(this, TrackingPixelData);

        this.id = data.id || 0;
        this.numberOfVisits = data.numberOfVisits || 0;
        this.campaign = new _campaign2.default(data.campaign);
        this.supplier = new _supplier2.default(data.supplier);
        this.month = data.month || "";
    };

    exports.default = TrackingPixelData;
});
define('services/api',["exports", "aurelia-fetch-client", "aurelia-router"], function (exports, _aureliaFetchClient, _aureliaRouter) {
    "use strict";
    ...
    var Api = function () {
        function Api(baseUrl, configuration) {
            var _this = this;

            var requestStatusService = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
            ...
            this.http.configure(function (config) {
                config.useStandardConfiguration().withBaseUrl(_this.apiUrl + "/" + baseUrl);
            });

            this.requestStatusService.isRequesting = false;
        }

        Api.prototype.get = function get(url, queryString, contentType) {
            queryString = queryString ? "?" + queryString : "";
            return this._ajax("" + url + queryString, null, "GET", contentType);
        };

        Api.prototype.post = function post(url, data, contentType) {
            return this._ajax(url, data, "POST", contentType);
        };

        Api.prototype.blob = function blob(url, data) {
            return this._ajax(url, data, "POST", "application/pdf");
        };

        Api.prototype.put = function put(url, data, contentType) {
            return this._ajax(url, data, "PUT", contentType);
        };

        Api.prototype.delete = function _delete(url, contentType) {
            return this._ajax(url, null, "DELETE", contentType);
        };

        Api.prototype.upload = function upload(url, data, files) {
            var _this2 = this;
            ...
            return this.http.fetch(url, {
                ...
                _this2.requestStatusService.isRequesting = false;
                return response.json();
            });
        };

        Api.prototype._ajax = function _ajax(url, data, method) {
            var _this3 = this;

            var contentType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "application/json; charset=utf-8";
            var files = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;

            this.requestStatusService.isRequesting = true;

            data = this._needsJsonBody(method) ? (0, _aureliaFetchClient.json)(data) : data;
            ...
            return this.http.fetch(url, {
                ...
                _this3.requestStatusService.isRequesting = false;
                if (contentType.includes("pdf")) return response.blob();
                return _this3._needsJsonResponse(method) ? response.json() : response;
            }).catch(function (error) {
                console.log(error);
                if (error.status === 401) _this3.router.navigate("login");
        ...
        Api.prototype._getSecurityHeaders = function _getSecurityHeaders(contentType) {
            var headers = new Headers();
            var accessToken = "token";

            if (contentType && contentType !== "application/json; charset=utf-8") headers.append("Content-Type", contentType);
        ...
        Api.prototype._needsJsonBody = function _needsJsonBody(method) {
            return method !== "GET";
        };

        Api.prototype._needsJsonResponse = function _needsJsonResponse(method) {
...
define('services/auth-service',["exports", "aurelia-framework", "aurelia-fetch-client", "./configuration", "./request-status-service"], function (exports, _aureliaFramework, _aureliaFetchClient, _configuration, _requestStatusService) {
    "use strict";
    ...
    var AuthService = (_dec = (0, _aureliaFramework.inject)(_aureliaFramework.Aurelia, _aureliaFetchClient.HttpClient, _configuration.Configure, _requestStatusService.RequestStatusService), _dec(_class = function () {
        function AuthService(aurelia, http, configuration, requestStatusService) {
            _classCallCheck(this, AuthService);

            http.configure(function (config) {
                config.useStandardConfiguration().withBaseUrl(configuration.get("api.endpoint"));
            });
        ...
        AuthService.prototype.logIn = function logIn(userData) {
            var _this = this;
            ...
            return this.http.fetch("/account/login", {
                ...
                method: "POST",
                body: (0, _aureliaFetchClient.json)(userData)
            }).then(function (response) {
                if (response.status === 200) {
                    _this.app.setRoot("app");
                    _this.requestStatusService.isRequesting = false;
                } else {
                    throw "Unauthorized";
                }
            });
        ...
        AuthService.prototype.logOff = function logOff() {
            var _this2 = this;

            this.requestStatusService.isRequesting = true;
            this.http.fetch("/account/logout").then(function () {
                _this2.app.setRoot("login");
                _this2.requestStatusService.isRequesting = false;
            });
        };

        AuthService.prototype.isAuthenticated = function isAuthenticated() {
            return this.http.fetch("/account/IsAuthenticated").then(function (response) {
                return response.json();
            });
        };
...
define('services/batch-service',["exports", "aurelia-framework", "./entity-service-base"], function (exports, _aureliaFramework, _entityServiceBase) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.BatchService = undefined;
    ...
    var BatchService = exports.BatchService = function (_EntityServiceBase) {
        _inherits(BatchService, _EntityServiceBase);
        ...
        function BatchService() {
            ...
            return _possibleConstructorReturn(this, _EntityServiceBase.call.apply(_EntityServiceBase, [this, "batch"].concat(rest)));
        }

        BatchService.prototype.uploadBatch = function uploadBatch(campaignId, supplierId, file) {
            return this.api.upload("/uploadBatch", { campaignId: campaignId, supplierId: supplierId }, [file]);
        };

        return BatchService;
    }(_entityServiceBase.EntityServiceBase);
});
define('services/campaign-service',["exports", "aurelia-framework", "./entity-service-base"], function (exports, _aureliaFramework, _entityServiceBase) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.CampaignService = undefined;
    ...
    var CampaignService = exports.CampaignService = function (_EntityServiceBase) {
        _inherits(CampaignService, _EntityServiceBase);
        ...
        function CampaignService() {
            ...
            return _possibleConstructorReturn(this, _EntityServiceBase.call.apply(_EntityServiceBase, [this, "campaign"].concat(rest)));
        }

        return CampaignService;
    }(_entityServiceBase.EntityServiceBase);
});
define('services/configuration',["exports"], function (exports) {
    "use strict";
    ...
    var Configure = exports.Configure = function () {
        ...
        Configure.prototype.setEnvironment = function setEnvironment() {
...
define('services/entity-service-base',["exports", "aurelia-framework", "./api", "aurelia-router", "./configuration", "./request-status-service"], function (exports, _aureliaFramework, _api, _aureliaRouter, _configuration, _requestStatusService) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.EntityServiceBase = undefined;
    ...
    var EntityServiceBase = exports.EntityServiceBase = (_dec = (0, _aureliaFramework.inject)(_configuration.Configure, _requestStatusService.RequestStatusService, _aureliaRouter.Router), _dec(_class = function () {
        function EntityServiceBase() {
            var baseUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
            var configuration = arguments[1];
            var requestStatusService = arguments[2];
            var router = arguments[3];

            _classCallCheck(this, EntityServiceBase);

            this.baseUrl = baseUrl;
            this.api = new _api2.default("" + this.baseUrl, configuration, requestStatusService, router);
        }

        EntityServiceBase.prototype.getAllItems = function getAllItems() {
            return this.api.get("/all").then(function (response) {
                return response;
            });
        };

        EntityServiceBase.prototype.get = function get(id) {
            return this.api.get("/" + id);
        };

        EntityServiceBase.prototype.edit = function edit(id) {
            return this.api.get("/edit", "id=" + id);
        };

        EntityServiceBase.prototype.save = function save(id, data) {
            return id ? this.api.post("/", data) : this.api.put("/", data);
        };

        EntityServiceBase.prototype.delete = function _delete(id) {
            return this.api.delete("/" + id);
        };

        EntityServiceBase.prototype.getPagedItems = function getPagedItems() {
...
define('services/lead-service',["exports", "aurelia-framework", "./entity-service-base"], function (exports, _aureliaFramework, _entityServiceBase) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.LeadService = undefined;
    ...
    var LeadService = exports.LeadService = function (_EntityServiceBase) {
        _inherits(LeadService, _EntityServiceBase);
        ...
        function LeadService() {
            ...
            return _possibleConstructorReturn(this, _EntityServiceBase.call.apply(_EntityServiceBase, [this, "lead"].concat(rest)));
        }

        return LeadService;
    }(_entityServiceBase.EntityServiceBase);
});
define('services/project-service',["exports", "aurelia-framework", "./entity-service-base"], function (exports, _aureliaFramework, _entityServiceBase) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ProjectService = undefined;
    ...
    var ProjectService = exports.ProjectService = function (_EntityServiceBase) {
        _inherits(ProjectService, _EntityServiceBase);
        ...
        function ProjectService() {
            ...
            return _possibleConstructorReturn(this, _EntityServiceBase.call.apply(_EntityServiceBase, [this, "project"].concat(rest)));
        }

        return ProjectService;
    }(_entityServiceBase.EntityServiceBase);
});
define('services/request-status-service',["exports"], function (exports) {
    "use strict";
    ...
    var RequestStatusService = exports.RequestStatusService = function () {
        function RequestStatusService() {
            _classCallCheck(this, RequestStatusService);

            this._isRequesting = false;
        }

        _createClass(RequestStatusService, [{
            key: "isRequesting",
            get: function get() {
...
define('services/supplier-service',["exports", "aurelia-framework", "./entity-service-base"], function (exports, _aureliaFramework, _entityServiceBase) {
    "use strict";
    ...
    var SupplierService = exports.SupplierService = function (_EntityServiceBase) {
        _inherits(SupplierService, _EntityServiceBase);
        ...
        function SupplierService() {
            ...
            return _possibleConstructorReturn(this, _EntityServiceBase.call.apply(_EntityServiceBase, [this, "supplier"].concat(rest)));
        }

        return SupplierService;
    }(_entityServiceBase.EntityServiceBase);
});
define('services/tracking-pixel-service',["exports", "aurelia-framework", "./entity-service-base"], function (exports, _aureliaFramework, _entityServiceBase) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.TrackingPixelService = undefined;
    ...
    var TrackingPixelService = exports.TrackingPixelService = function (_EntityServiceBase) {
        _inherits(TrackingPixelService, _EntityServiceBase);

        function TrackingPixelService() {
            _classCallCheck(this, TrackingPixelService);

            for (var _len = arguments.length, rest = Array(_len), _key = 0; _key < _len; _key++) {
                rest[_key] = arguments[_key];
            }

            return _possibleConstructorReturn(this, _EntityServiceBase.call.apply(_EntityServiceBase, [this, "/tracking"].concat(rest)));
        }
...
define('resources/index',["exports"], function (exports) {
    ...
    function configure(config) {
        config.globalResources(["./value-converters/converters", "./elements/loading-indicator"]);
    }
});
...
define('resources/value-converters/converters',["exports"], function (exports) {
    ...
    var BooleanToTextValueConverter = exports.BooleanToTextValueConverter = function () {
        function BooleanToTextValueConverter() {
            _classCallCheck(this, BooleanToTextValueConverter);
        }

        BooleanToTextValueConverter.prototype.toView = function toView(value) {
            return value ? "Ja" : "Nee";
        };

        return BooleanToTextValueConverter;
    }();
    ...
    var CapitalizeWordsValueConverter = exports.CapitalizeWordsValueConverter = function () {
        ...
        CapitalizeWordsValueConverter.prototype.fromView = function fromView(value) {
    ...
    var CurrencyValueConverter = exports.CurrencyValueConverter = function () {
        ...
        CurrencyValueConverter.prototype.toView = function toView(value) {
            var withCurrencySymbol = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;


            numeral.language("nl-nl", nl);
            numeral.language("nl-nl");

            var currencySymbol = withCurrencySymbol ? "$" : "";
            return numeral(value).format(currencySymbol + "0,0.00");
        };

        CurrencyValueConverter.prototype.fromView = function fromView(value) {
    ...
    var NumericValueConverter = exports.NumericValueConverter = function () {
        function NumericValueConverter() {
            _classCallCheck(this, NumericValueConverter);
        }

        NumericValueConverter.prototype.toView = function toView(value) {
        ...
        NumericValueConverter.prototype.fromView = function fromView(value) {
            var useDecimals = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    ...
    var SkipValueConverter = exports.SkipValueConverter = function () {
        function SkipValueConverter() {
            _classCallCheck(this, SkipValueConverter);
        }

        SkipValueConverter.prototype.toView = function toView(array, count) {
    ...
    function _toFixedFloat(x, precision) {
        ...
        var value = x.replace(/[,]/g, ".").replace(/[^\.\d]/g, "");
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=nav-bar.html></require><require from=bootstrap/css/bootstrap.css></require><require from=humane-js/themes/jackedup.css></require><require from=nprogress/nprogress.css></require><loading-indicator loading.bind=\"router.isNavigating || requestStatusService.isRequesting\"></loading-indicator><nav-bar router.bind=router auth.bind=auth></nav-bar><div class=page-host><router-view></router-view></div></template>"; });
define('text!batch-upload.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2><div class=row><div class=col-sm-12><form submit.delegate=upload()><section><div class=form-group><label>Campaign</label><div class=input-group><select value.bind=selectedCampaignId class=form-control><option value=\"\">-- none --</option><option repeat.for=\"campaign of campaigns\" model.bind=campaign.id>${campaign.name}</option></select></div></div><div class=form-group><label>Supplier</label><div class=input-group><select value.bind=selectedSupplierId class=form-control><option value=\"\">-- none --</option><option repeat.for=\"supplier of suppliers\" model.bind=supplier.id>${supplier.name}</option></select></div></div><div class=form-group><label for=files class=\"col-sm-2 btn btn-default\">Batch file</label><div class=input-group><div class=col-sm-7><div class=input-group><input id=files type=file accept=.xlsx files.bind=selectedFiles class=form-control style=display:none></div></div></div></div></section><section class=\"box-footer borderized\"><div class=row><div class=\"col-sm-12 form-group\"><div class=input-group><input type=submit class=\"btn btn-primary\" value=Upload if.bind=canUpload disabled.bind=requestStatus.isRequesting></div></div></div></section></form></div></div></section></template>"; });
define('text!campaigns-overview.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2><div class=table-responsive><table class=\"table table-hover table-condensed\"><thead><tr><th>Id</th><th>Campagne</th><th>Klant</th></tr></thead><tbody><tr repeat.for=\"campaign of campaigns\"><td>${campaign.id}</td><td>${campaign.name}</td><td>${campaign.customer.name}</td></tr></tbody></table></div><div class=row if.bind=\"projects.length > 0\"><div class=col-sm-12><compose view=./components/pagination.html></compose></div></div></section></template>"; });
define('text!home.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2></section></template>"; });
define('text!leads-overview.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2><div class=table-responsive><table class=\"table table-hover table-condensed\"><thead><tr><th>id</th><th>supplierId</th><th>campaignId</th><th>date</th><th>gender</th><th>initials</th><th>name</th><th>surname</th><th>dateOfBirth</th><th>emailAddress</th><th>address</th><th>street</th><th>houseNumber</th><th>houseNumberAddition</th><th>postcode</th><th>city</th><th>phone1</th><th>phone2</th><th>country</th><th>delivery</th><th>source</th><th>partnerId</th><th>soi_timestamp</th><th>soi_ip</th><th>doi_timestamp</th><th>doi_ip</th><th>answer</th><th>interface</th><th>newsletter</th><th>status</th><th>error</th></tr></thead><tbody><tr repeat.for=\"lead of leads\" class.bind=\"lead.status === 'Pending' ? 'success' : 'danger' \"><td>${lead.id}</td><td>${lead.supplierId}</td><td>${lead.customerId}</td><td>${lead.projectId}</td><td>${lead.campaignId}</td><td>${lead.date}</td><td>${lead.gender}</td><td>${lead.initials}</td><td>${lead.name}</td><td>${lead.surname}</td><td>${lead.dateOfBirth}</td><td>${lead.emailAddress}</td><td>${lead.address}</td><td>${lead.street}</td><td>${lead.houseNumber}</td><td>${lead.houseNumberAddition}</td><td>${lead.postcode}</td><td>${lead.city}</td><td>${lead.phone1}</td><td>${lead.phone2}</td><td>${lead.country}</td><td>${lead.delivery}</td><td>${lead.source}</td><td>${lead.partnerId}</td><td>${lead.soi_timestamp}</td><td>${lead.soi_ip}</td><td>${lead.doi_timestamp}</td><td>${lead.doi_ip}</td><td>${lead.answer}</td><td>${lead.interface}</td><td>${lead.newsletter}</td><td>${lead.status}</td><td>${lead.errorDescription}</td></tr></tbody></table></div><div class=row if.bind=\"leads.length > 0\"><div class=col-sm-12><compose view=./components/pagination.html></compose></div></div></section></template>"; });
define('text!login.html', ['module'], function(module) { module.exports = "<template><require from=bootstrap/css/bootstrap.css></require><div class=container><div class=row><div class=\"col-md-4 col-md-offset-4\"><div class=\"login-panel panel panel-default\"><div class=panel-heading><h3 class=panel-title>Inloggen</h3></div><div class=panel-body><p if.bind=error class=text-danger>Gebruikersnaam of wachtwoord ongeldig</p><form role=form id=loginForm submit.trigger=login()><fieldset><div class=form-group><input class=form-control placeholder=E-mail name=username type=email autofocus value.bind=username></div><div class=form-group><input class=form-control placeholder=Wachtwoord name=password type=password value.bind=password></div><div class=checkbox><label><input name=remember type=checkbox checked.bind=rememberMe>Onthoud mij</label></div><button type=submit class=\"btn btn-lg btn-success btn-block\" disabled.bind=busy>Login</button></fieldset></form></div></div></div></div></div></template>"; });
define('text!nav-bar.html', ['module'], function(module) { module.exports = "<template bindable=\"router, auth\"><nav class=\"navbar navbar-default navbar-fixed-top\" role=navigation><div class=navbar-header><button type=button class=navbar-toggle data-toggle=collapse data-target=#skeleton-navigation-navbar-collapse><span class=sr-only>Toggle Navigation</span><span class=icon-bar></span><span class=icon-bar></span><span class=icon-bar></span></button><a class=navbar-brand href=#><i class=\"fa fa-home\"></i><span>${router.title}</span></a></div><div class=\"collapse navbar-collapse\" id=skeleton-navigation-navbar-collapse><ul class=\"nav navbar-nav\"><li repeat.for=\"row of router.navigation\" class=\"${row.isActive ? 'active' : ''}\"><a data-toggle=collapse data-target=#skeleton-navigation-navbar-collapse.in href.bind=row.href>${row.title}</a></li></ul><ul class=\"nav navbar-nav navbar-right\"><li><a href=\"\" click.delegate=auth.logOff()><i class=\"fa fa-sign-out fa-fw\"></i>Logout</a></li><li class=loader if.bind=router.isNavigating><i class=\"fa fa-spinner fa-spin fa-2x\"></i></li></ul></div></nav></template>"; });
define('text!projects-overview.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2><div class=table-responsive><table class=\"table table-hover table-condensed\"><thead><tr><th>id</th><th>naam</th></tr></thead><tbody><tr repeat.for=\"project of projects\"><td>${project.id}</td><td>${project.name}</td></tr></tbody></table></div><div class=row if.bind=\"projects.length > 0\"><div class=col-sm-12><compose view=./components/pagination.html></compose></div></div></section></template>"; });
define('text!suppliers-overview.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2><div class=table-responsive><table class=\"table table-hover table-condensed\"><thead><tr><th>id</th><th>naam</th></tr></thead><tbody><tr repeat.for=\"supplier of suppliers\"><td>${supplier.id}</td><td>${supplier.name}</td></tr></tbody></table></div><div class=row if.bind=\"suppliers.length > 0\"><div class=col-sm-12><compose view=./components/pagination.html></compose></div></div></section></template>"; });
define('text!tracking-pixel-information.html', ['module'], function(module) { module.exports = "<template><section class=au-animate><h2>${heading}</h2><table class=\"table table-responsive table-hover table-striped\"><thead><tr><th>Campagne</th><th>Supplier</th><th>Aantal leads</th><th>Maand</th></tr></thead><tbody><tr repeat.for=\"data of trackingPixelData\"><td>${data.campaign.name}</td><td>${data.supplier.name}</td><td>${data.numberOfVisits}</td><td>${data.month}</td></tr></tbody></table></section></template>"; });
define('text!components/pagination.html', ['module'], function(module) { module.exports = "<template><nav><ul class=pagination if.bind=\"numberOfPages <= 10\"><li if.bind=\"currentPage > 1\"><a href=\"\" click.delegate=\"getPage(currentPage-1, filter)\"><span aria-hidden=true>&laquo;</span><span class=sr-only>Vorige</span></a></li><li repeat.for=\"page of pages\" class=\"${$parent.currentPage === page ? 'active' : ''}\"><a href=\"\" click.delegate=\"$parent.getPage(page, filter)\">${page}</a></li><li if.bind=\"currentPage < numberOfPages\"><a href=\"\" click.delegate=\"getPage(currentPage+1, filter)\"><span aria-hidden=true>&raquo;</span><span class=sr-only>Volgende</span></a></li></ul><ul class=pagination if.bind=\"numberOfPages > 10\"><li if.bind=\"currentPage > 1\"><a href=\"\" click.delegate=\"getPage(1, filter)\"><span>Eerste</span></a></li><li if.bind=\"currentPage > 1\"><a href=\"\" click.delegate=\"getPage(currentPage-1, filter)\"><span aria-hidden=true>&laquo;</span><span class=sr-only>Vorige</span></a></li><li if.bind=\"currentPage > 6\" class=disabled><a>...</a></li><li if.bind=\"currentPage > 1 && currentPage < numberOfPages - 4\" repeat.for=\"page of pages | skip: (currentPage > 5 ? currentPage - 6 : 0) | take: (currentPage > 6 ? 5 : currentPage - 1)\"><a href=\"\" click.delegate=\"$parent.getPage(page, filter)\">${page}</a></li><li if.bind=\"currentPage > 1 && numberOfPages > currentPage && currentPage >= (numberOfPages - 4)\" repeat.for=\"page of pages | skip: currentPage - (10 - (numberOfPages - currentPage))  | take: 9 - (numberOfPages - currentPage)\"><a href=\"\" click.delegate=\"$parent.getPage(page, filter)\">${page}</a></li><li if.bind=\"currentPage === numberOfPages\" repeat.for=\"page of pages | skip: numberOfPages - 10 | take: 9\"><a href=\"\" click.delegate=\"$parent.getPage(page, filter)\">${page}</a></li><li class=active><a>${currentPage}</a></li><li repeat.for=\"page of pages | skip: currentPage | take: (currentPage <= 6) ? 10 - currentPage : 4\"><a href=\"\" click.delegate=$parent.getPage(page)>${page}</a></li><li if.bind=\"currentPage < (numberOfPages - 5)\" class=disabled><a>...</a></li><li if.bind=\"currentPage < numberOfPages\"><a href=\"\" click.delegate=\"getPage(currentPage+1, filter)\"><span aria-hidden=true>&raquo;</span><span class=sr-only>Volgende</span></a></li><li if.bind=\"currentPage < numberOfPages\"><a href=\"\" click.delegate=\"getPage(numberOfPages, filter)\"><span>Laatste</span></a></li></ul></nav></template>"; });
